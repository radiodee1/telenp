...
function changeAlertText() {
	...
	if (control_connected) connected = "<b style='color:yellow'>" + "[connected]";
	...
	if (control_obstructed) obstructed = "<b style='color:red'>" + "[blocked]";
	else obstructed = "<b style='color:green'>" + "[clear]";
...
function recieveEvent () {
	...
	if (rx_data != rx_data_old) { 
		...
		if (rx_obj.direction == "stop") stream_num = 0;

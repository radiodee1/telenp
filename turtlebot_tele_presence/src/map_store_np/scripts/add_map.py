...
list_last_maps = rospy.ServiceProxy('/list_maps', map_store_np.srv.ListMaps)
delete_map = rospy.ServiceProxy('/delete_map', map_store_np.srv.DeleteMap)
maps = []
try:
...
save_map = rospy.ServiceProxy('/save_map', map_store_np.srv.SaveMap)

...
if(NOT "/home/dave/workspace/telenp/turtlebot_tele_presence/devel/include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'tele_presence' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dave/workspace/telenp/turtlebot_tele_presence/src/tele_presence/${idir}'.  Ask the maintainer 'David Liebman <david.c.liebman@gmail.com>' to fix it.")
    endif()
    _list_append_unique(tele_presence_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "tele_presence")
...
foreach(depend ${depends})
  ...
  _pack_libraries_with_build_configuration(tele_presence_LIBRARIES ${tele_presence_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${tele_presence_dep}_LIBRARIES})
  _list_append_deduplicate(tele_presence_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(tele_presence_LIBRARIES ${tele_presence_LIBRARIES})

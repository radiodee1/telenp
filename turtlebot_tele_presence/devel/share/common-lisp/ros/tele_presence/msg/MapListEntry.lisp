...
(cl:defmethod cl:initialize-instance :after ((m <MapListEntry>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MapListEntry)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tele_presence-msg:<MapListEntry> is deprecated: use tele_presence-msg:MapListEntry instead.")))

...
(cl:in-package map_store_np-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <MapListEntry>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MapListEntry)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name map_store_np-msg:<MapListEntry> is deprecated: use map_store_np-msg:MapListEntry instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <MapListEntry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_store_np-msg:name-val is deprecated.  Use map_store_np-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'session_id-val :lambda-list '(m))
(cl:defmethod session_id-val ((m <MapListEntry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_store_np-msg:session_id-val is deprecated.  Use map_store_np-msg:session_id instead.")
  (session_id m))

(cl:ensure-generic-function 'date-val :lambda-list '(m))
(cl:defmethod date-val ((m <MapListEntry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_store_np-msg:date-val is deprecated.  Use map_store_np-msg:date instead.")
  (date m))

(cl:ensure-generic-function 'map_id-val :lambda-list '(m))
(cl:defmethod map_id-val ((m <MapListEntry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_store_np-msg:map_id-val is deprecated.  Use map_store_np-msg:map_id instead.")
  (map_id m))

...
(cl:defmethod cl:initialize-instance :after ((m <SaveMap-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SaveMap-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name map_store_np-srv:<SaveMap-request> is deprecated: use map_store_np-srv:SaveMap-request instead.")))

(cl:ensure-generic-function 'map_name-val :lambda-list '(m))
(cl:defmethod map_name-val ((m <SaveMap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_store_np-srv:map_name-val is deprecated.  Use map_store_np-srv:map_name instead.")
  (map_name m))
...
(cl:defmethod cl:initialize-instance :after ((m <SaveMap-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SaveMap-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name map_store_np-srv:<SaveMap-response> is deprecated: use map_store_np-srv:SaveMap-response instead.")))

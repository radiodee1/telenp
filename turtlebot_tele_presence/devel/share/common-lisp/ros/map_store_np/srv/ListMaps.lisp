...
(cl:defmethod cl:initialize-instance :after ((m <ListMaps-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ListMaps-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name map_store_np-srv:<ListMaps-request> is deprecated: use map_store_np-srv:ListMaps-request instead.")))
...
(cl:defclass <ListMaps-response> (roslisp-msg-protocol:ros-message)
  ((map_list
    :reader map_list
    :initarg :map_list
    :type (cl:vector map_store_np-msg:MapListEntry)
   :initform (cl:make-array 0 :element-type 'map_store_np-msg:MapListEntry :initial-element (cl:make-instance 'map_store_np-msg:MapListEntry))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ListMaps-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ListMaps-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name map_store_np-srv:<ListMaps-response> is deprecated: use map_store_np-srv:ListMaps-response instead.")))

(cl:ensure-generic-function 'map_list-val :lambda-list '(m))
(cl:defmethod map_list-val ((m <ListMaps-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_store_np-srv:map_list-val is deprecated.  Use map_store_np-srv:map_list instead.")
  (map_list m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ListMaps-response>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'map_list)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'map_store_np-msg:MapListEntry))

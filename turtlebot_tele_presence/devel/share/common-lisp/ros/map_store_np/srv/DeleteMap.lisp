...
(cl:defmethod cl:initialize-instance :after ((m <DeleteMap-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DeleteMap-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name map_store_np-srv:<DeleteMap-request> is deprecated: use map_store_np-srv:DeleteMap-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <DeleteMap-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DeleteMap-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name map_store_np-srv:<DeleteMap-response> is deprecated: use map_store_np-srv:DeleteMap-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DeleteMap-response>)))
  ...
  "map_store_np/DeleteMapResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DeleteMap-response)))
  "Returns string type for a service object of type 'DeleteMap-response"
  "map_store_np/DeleteMapResponse")

...
(cl:defmethod cl:initialize-instance :after ((m <RenameMap-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RenameMap-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name map_store_np-srv:<RenameMap-request> is deprecated: use map_store_np-srv:RenameMap-request instead.")))

(cl:ensure-generic-function 'map_id-val :lambda-list '(m))
(cl:defmethod map_id-val ((m <RenameMap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_store_np-srv:map_id-val is deprecated.  Use map_store_np-srv:map_id instead.")
  (map_id m))

(cl:ensure-generic-function 'new_name-val :lambda-list '(m))
(cl:defmethod new_name-val ((m <RenameMap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_store_np-srv:new_name-val is deprecated.  Use map_store_np-srv:new_name instead.")
  (new_name m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RenameMap-request>)))
  ...
  (cl:format cl:nil "~%~%string map_id~%string new_name~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RenameMap-request)))
  "Returns full string definition for message of type 'RenameMap-request"
  (cl:format cl:nil "~%~%string map_id~%string new_name~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <RenameMap-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RenameMap-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name map_store_np-srv:<RenameMap-response> is deprecated: use map_store_np-srv:RenameMap-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RenameMap-response>)))
  ...
  "map_store_np/RenameMapResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RenameMap-response)))
  "Returns string type for a service object of type 'RenameMap-response"
  "map_store_np/RenameMapResponse")

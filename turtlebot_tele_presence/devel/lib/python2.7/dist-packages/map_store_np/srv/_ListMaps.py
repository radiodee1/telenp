"""autogenerated by genpy from map_store_np/ListMapsRequest.msg. Do not edit."""
import sys
...
class ListMapsRequest(genpy.Message):
  ...
  _type = "map_store_np/ListMapsRequest"
...
"""autogenerated by genpy from map_store_np/ListMapsResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import map_store_np.msg

class ListMapsResponse(genpy.Message):
  _md5sum = "ca5a33dd106a2c24cfd54c927d214957"
  _type = "map_store_np/ListMapsResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  __slots__ = ['map_list']
  _slot_types = ['map_store_np/MapListEntry[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = map_store_np.msg.MapListEntry()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end

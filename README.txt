...
You may have to run the script 'set-workspace.bash' to use the ROS node. This is located in the 'telenp' folder. You would type the following to get that to work.
